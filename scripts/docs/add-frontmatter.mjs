 ...
 *
 * Excludes: docs/i18n/, docs/superpowers/, docs/diagrams/exported/.
 *           Subfolder READMEs are included.
 *
...
const EXCLUDE_PREFIXES = ["docs/i18n/", "docs/superpowers/", "docs/diagrams/exported/"];
